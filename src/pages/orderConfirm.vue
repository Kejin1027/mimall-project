            ...
            <div class="addr-list clearfix">
              <div class="addr-info" :class="{'checked': index == checkIndex}" @click="checkIndex = index" v-for="(item, index) in list" :key="index">
                ...
                <div class="action">
                  ...
                  <a href="javascript:;" class="fr" @click="editAdressModal(item)">
  ...
  methods:{
    ...
    submitAddress(){
      ...
      if(userAction == 0 || userAction == 1){
        let {receiverName, receiverMobile, receiverProvince,
        receiverCity, receiverDistrict, receiverAddress, receiverZip} = checkItem
        let errMsg;
        if(!receiverName){
          errMsg = '请输入收货人名称'
